...
Digital Counter is a jQuery application for tracking and counting various activities. The legacy version in the root directory is the active version (Vue 3 migration was attempted but reverted).

**Documentation:** See `docs/` folder for `SETUP_FIREBASE.md` and `LEGACY_ARCHITECTURE.md`.
